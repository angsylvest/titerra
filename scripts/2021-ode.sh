...
if [ -n "$MSIARCH" ]; then # Running on MSI
    ...
    export FORDYCA_ROOT=$HOME/research/projects/fordyca
    export SIERRA_PROJECT_PATH=$HOME/research/titerra/titerra/projects  # was titerra 
    export PYTHONPATH=$HOME/research/titerra
fi
